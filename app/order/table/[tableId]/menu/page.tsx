    ...
    return (
      <main className="mx-auto w-full max-w-md px-4 pt-4">
        <section className="rounded-[1.75rem] border border-[var(--brand-brown-opaque)] bg-[var(--brand-white)] p-6 text-center shadow-[0_18px_40px_-24px_rgba(74,44,33,0.04)]">
          ...
          <Link href="/" className="mt-6 inline-flex min-h-[3rem] w-full items-center justify-center rounded-2xl bg-[var(--brand-brown)] px-4 text-sm font-semibold text-[var(--brand-white)] transition hover:brightness-95">Go Home</Link>
        </section>
      </main>
    );
  }

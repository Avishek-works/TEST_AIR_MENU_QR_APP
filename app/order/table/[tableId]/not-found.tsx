...
export default function TableNotFound() {
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center p-4">
      <section className="rounded-3xl border border-[var(--border)] bg-[var(--brand-beige)] p-6 text-center shadow-[0_24px_56px_-24px_rgba(0,0,0,0.55)]">
        <p className="text-3xl">🔍</p>
        <h1 className="mt-4 text-2xl font-bold text-[var(--brand-brown)] tracking-tight">Table not found</h1>
